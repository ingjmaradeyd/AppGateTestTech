...
@Component
public class MultiplicationImpl implements MathOperation {
	
	private static final String port = "8092";
	private static final String operation = "/multservice/multiplicationoperation";

	private Response callServiceMultiplication(BigDecimal number1, BigDecimal number2) {
	...
	public Response operate(OperationObject operationObject) {
		return callServiceMultiplication(operationObject.getNumber1(), operationObject.getNumber2());
	}
